...
class MainWindow(QLabel):
    ...
    def setupUi(self):
        ...
        self.line_edit_windws.textChanged.connect(self.convert_line_edit_debian) # editline
        ...
        self.line_edit_debian.textChanged.connect(self.convert_line_edit_windws) # editline
